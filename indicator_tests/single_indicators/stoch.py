...
for i in range(100, 1000):  # Fetch historical data
    ...
    if (df['stoch_k'][i] > df['stoch_d'][i] + 2):
        while (bitcoins[x] < 1):
            buy(x, i)
    elif (df['stoch_k'][i] < df['stoch_d'][i] - 2):
        while(bitcoins[x] > -1):
            sell(x, i)
    elif (bitcoins[x] == 1):
        sell(x, i)
    ...
    if (df['stoch_k'][i] > df['stoch_d'][i] + 4):
        while (bitcoins[x] < 1):
            buy(x, i)
    elif (df['stoch_k'][i] < df['stoch_d'][i] - 4):
        while(bitcoins[x] > -1):
            sell(x, i)
    elif (bitcoins[x] == 1):
        sell(x, i)
    ...
    if (df['stoch_k'][i] > df['stoch_d'][i] + 7):
        while (bitcoins[x] < 1):
            buy(x, i)
    elif (df['stoch_k'][i] < df['stoch_d'][i] - 7):
        while(bitcoins[x] > -1):
            sell(x, i)
    elif (bitcoins[x] == 1):
        sell(x, i)
    ...
    if (df['stoch_k'][i] > df['stoch_d'][i] + 10):
        while (bitcoins[x] < 1):
            buy(x, i)
    elif (df['stoch_k'][i] < df['stoch_d'][i] - 10):
        while(bitcoins[x] > -1):
            sell(x, i)
    elif (bitcoins[x] == 1):
        sell(x, i)
